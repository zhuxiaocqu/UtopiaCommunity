...
public class LetterUploadRequest implements iLiveRequest {
	...
	public LetterUploadRequest(AQuery aq, String listener) {
		this.aq = aq;
	 ...
	 *            : 私信附图地址
	 */
	public void request(String account, String password, Long authorid,
